...
const GROUPS = [
  ...
  },
  {
    ...
    kicker: "Bloques",
    tone: "warning",
    blurb: "Piezas completas de producto: carrusel de chips, bloqueo por PIN al iniciar, carga de importes tipo billetera, timer que redirige a otra plataforma, compartir nativo y grilla de cards con columnas ajustables.",
    sections: [
      { id: "chips",    label: "Carrusel de chips" },
      { id: "pinlock",  label: "PIN / contraseña" },
      { id: "amount",   label: "Carga de importes" },
      { id: "timer",    label: "Timer + redirección" },
      { id: "share",    label: "Compartir" },
      { id: "cardgrid", label: "Grid de cards" },
    ],
  },
  {
    id: "pwa-group",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-24">
          ...
          <div className="flex gap-10">
            ...
            <div className="flex-1 min-w-0">
              ...
              <GroupHeader group={GROUPS[4]} count="7 componentes"/>
              <BlocksSections/>

              <GroupHeader group={GROUPS[5]} count="11 componentes · 12 hooks"/>
              <PwaSection/>
              <PwaMoleculesSection/>
              <SplashSection/>
              <SafeAreaSection/>

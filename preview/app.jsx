...
function IntroSection() {
  return (
    <Section id="intro" title="12 componentes atómicos · 3 de datos · 6 moléculas PWA">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-24">
          ...
          <div className="pt-14 pb-10 max-w-2xl">
            ...
            <p className="mt-5 text-base text-muted leading-relaxed max-w-xl">
              12 componentes atómicos, 3 grillas de datos y 6 moléculas PWA listas para arrancar cualquier proyecto Next.js. Animaciones con
          ...
          <div className="flex gap-10">
            ...
            <div className="flex-1 min-w-0">
              ...
              <GroupHeader group={GROUPS[2]} count="11 componentes · 12 hooks"/>
              <PwaSection/>
              <PwaMoleculesSection/>
              <SplashSection/>
              <SafeAreaSection/>

...
export function FlashcardDeckSection() {
...
export function QuizCardSection() {
...
export function StreakTrackerSection() {
  return (
    <Section
      id="streaktracker"
      title="StreakTracker"
...
export function ProgressByTopicSection() {
...
export function MatchingPairsSection() {

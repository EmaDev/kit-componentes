...
export function RouletteWheelSection() {
...
export function CoinFlipSection() {
...
export function NumberGeneratorSection() {
  return (
    <Section
      id="numbergenerator"
...
export function RaffleDrawSection() {
...
export function TeamShufflerSection() {
  return (
    <Section
      id="teamshuffler"
      title="TeamShuffler"
...
export function TallyCounterSection() {
  return (
    <Section
      id="tallycounter"
      title="TallyCounter"

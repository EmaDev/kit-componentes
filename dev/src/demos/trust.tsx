...
export function ShippingMethodPickerSection() {
...
export function ProductComparisonTableSection() {
  return (
...
export function StockLimitedStepperSection() {
...
export function ApprovalChecklistSection() {
  return (
...
export function RolePermissionsTableSection() {
...
export function SecurityAlertBannerSection() {
  return (
...
export function PageStatusScreenSection() {
  return (
...
export function MaintenancePageSection() {
  return (

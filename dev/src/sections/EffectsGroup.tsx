...
function SwipeableCardStackSection() {
  return (
...
function FlipRevealGridSection() {
  return (
...
function ParallaxScrollCardsSection() {
  return (
...
function AnimatedProgressRingSection() {
  return (
...
function DragReorderListSection() {
...
export function EffectsGroup() {
  return (
    <>
      <CardFanSection />
      <SwipeableCardStackSection />
      <FlipRevealGridSection />
      <AnimatedCounterSection />
      <SkeletonMorphSection />
      <ParallaxScrollCardsSection />
      <TiltHoverCardSection />
      <AnimatedProgressRingSection />
      <DragReorderListSection />
      <VideoCallGridSection />
    </>
  );
}

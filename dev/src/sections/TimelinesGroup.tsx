...
function BranchingTimelineSection() {
  return (
...
function TrackingStepperSection() {
  return (
...
function TimelineCommentsSection() {
...
function GroupedActivityFeedSection() {
  return (
...
export function TimelinesGroup() {
  return (
    <>
      <ActivityTimelineSection />
      <BranchingTimelineSection />
      <TrackingStepperSection />
      <TimelineCommentsSection />
      <GroupedActivityFeedSection />
      <AuditLogSection />
      <RoadmapSection />

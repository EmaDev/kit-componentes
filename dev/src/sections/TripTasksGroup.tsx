...
function TripBudgetSummarySection() {
  return (
...
function GroupedTaskListSection() {
...
export function TripTasksGroup() {
  return (
    <>
      <ItineraryTimelineSection />
      <TripRouteMapSection />
      <TripBudgetSummarySection />
      <TripChecklistSection />
      <GroupedTaskListSection />
      <TaskCardSection />
    </>
  );
}

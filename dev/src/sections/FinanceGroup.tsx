...
function WalletBalanceCardSection() {
  return (
...
function CurrencySelectorSection() {
...
function RateComparatorSection() {
  return (
...
function ValueHistoryChartSection() {
  return (
...
function JsonChartViewerSection() {
  return (
...
function BudgetCategoryProgressSection() {
  return (
...
function PaymentMethodPickerSection() {
...
export function FinanceGroup() {
  return (
    <>
      <KpiCardSection />
      <WalletBalanceCardSection />
      <CurrencySelectorSection />
      <RateComparatorSection />
      <ValueHistoryChartSection />
      <JsonChartViewerSection />
      <TransactionListSection />
      <SendMoneyFlowSection />
      <PaymentQrCardSection />
      <BillSplitterSection />
      <BudgetCategoryProgressSection />
      <PaymentMethodPickerSection />
    </>
  );
}
